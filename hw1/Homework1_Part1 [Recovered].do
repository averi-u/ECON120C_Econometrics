...
scalar beta0 =  10         /* choose an integer number between 1 and 20 */
scalar beta1 =  1.2         /* choose a number greater than 0 but less than 2 */
						 /* use one one decimal place for your number. */
						
capture postclose tempid 

postfile tempid beta1_hat se_beta1hat t_stat reject using ols_estimates_u2,replace
...
clear
use ols_estimates_u2      /* this dataset contains the simulation results */
...
graph export beta_hat_unbiased2.pdf, replace
...
hist t_stat, normal title("sampling distribution of t_stat")         
					 ...
					 overlay a normal density with the same mean and variance */ 
graph export t_stat_unbiased2.pdf, replace
